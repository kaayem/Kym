...
mydoc4 = db.attributes.aggregate([{'$project' : {'_id':0,'code':1,'source':1, 'report':1, 'attribute':'$attribute'}},{'$unwind':'$attribute'},{'$project':{'_id':0,'code':1,'source':1,'report':1,'std' : '$attribute.value','raw': '$attribute.name'}},{'$match':{'code':{'$in':[CODE,]},'source':{'$in':[SOURCE,]}}}])
doc5 = []
for x in mydoc4:
     doc5.append(x)
print("complete3")
