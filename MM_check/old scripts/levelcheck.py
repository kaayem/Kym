...
mydoc4 = db.attributes.aggregate([{'$project' : {'_id':0,'code':1,'source':1, 'report':1, 'level':'$level'}},{'$unwind':'$level'},{'$project':{'_id':0,'code':1,'source':1,'report':1,'std' : '$level.value','raw': '$level.name'}},{'$match':{'code':{'$in':[CODE,]},'source':{'$in':[SOURCE,]}}}])
doc5 = []
for x in mydoc4:
     doc5.append(x)
print("complete3")
